...
function tinymce_settings() {
  return array(
	'theme_advanced_buttons1' => 'bold, italic, underline, strikethrough, bullist, numlist, code, formatselect, fullscreen'
  );
}
 ...
 */
function cvtx_create_antrag_form($cvtx_antrag_top   = 0,  $cvtx_antrag_title = '', $cvtx_antrag_text  = '', 
		$cvtx_antrag_steller = '', $cvtx_antrag_email = '', $cvtx_antrag_phone = '', $cvtx_antrag_grund = '') {
	?>	
    ...
    <fieldset class="fieldset">
			<div class="legend"><h3>Antragstitel</h3></div>
    
    	<div class="form-item">
      	<label for="cvtx_antrag_title"><?php echo __('Title', 'cvtx'); ?>: <span class="form-required" title="<?php echo __('This field is mandatory', 'cvtx'); ?>">*</span></label><br/>
      	<input type="text" id="cvtx_antrag_title" name="cvtx_antrag_title" class="required" value="<?php echo $cvtx_antrag_title; ?>" size="80" /><br />
    	</div>
    
    	<div class="form-item">
    		<label for="cvtx_antrag_top"><?php echo __('Agenda point', 'cvtx'); ?>: <span class="form-required" title="<?php echo __('This field is mandatory', 'cvtx'); ?>">*</span></label><br />
    ...
    <fieldset class="fieldset">
	    <div class="legend"><h3><?php echo __('Author(s)', 'cvtx'); ?></h3></div>
    
	    <div class="form-item">
  		  <label for="cvtx_antrag_steller"><?php echo __('Author(s)', 'cvtx'); ?>: <span class="form-required" title="<?php echo __('This field is mandatory', 'cvtx'); ?>">*</span></label><br/>
	    ...
	    <div class="form-item">
    		<label for="cvtx_antrag_email"><?php echo __('E-mail address', 'cvtx'); ?>: <span class="form-required" title="<?php echo __('This field is mandatory', 'cvtx'); ?>">*</span></label> (<?php echo __('will not be published', 'cvtx'); ?>)<br/>
		    <input type="text" id="cvtx_antrag_email" name="cvtx_antrag_email" class="required" value="<?php echo $cvtx_antrag_email; ?>" size="70" /><br/>
   	 	</div>
    
    	<div class="form-item">
    		<label for="cvtx_antrag_phone"><?php echo __('Mobile number', 'cvtx'); ?>: <span class="form-required" title="<?php echo __('This field is mandatory', 'cvtx'); ?>">*</span></label> (<?php echo __('will not be published', 'cvtx'); ?>)<br/>
    ...
    <fieldset class="fieldset">
    	<div class="legend"><h3>Antragstext</h3></div>
    
	    <div class="form-item">
    		<label for="cvtx_antrag_text"><?php echo __('Text', 'cvtx'); ?>: <span class="form-required" title="<?php echo __('This field is mandatory', 'cvtx'); ?>">*</span></label><br/>
	    ...
	    <div class="form-item">
	  	  <label for="cvtx_antrag_grund"><?php echo __('Explanation', 'cvtx'); ?>:</label><br/>
    ...
    <fieldset class="fieldset">
	    <div class="legend"><h3><?php echo __('Submit'); ?></h3></div>
	    ...
	    <div class="form-item">
  		  <input type="submit" id="cvtx_antrag_submit" class="submit" value="<?php echo __('Submit resolution', 'cvtx'); ?>">
    	</div>
        ...
        if(!is_plugin_active('wp-recaptcha/wp-recaptcha.php') || $resp->is_valid) {
            ...
            // return error-message because some required fields have not been submitted
                ...
                echo '<p id="message" class="error">Der Antrag konnte nicht gespeichert werden, weil einige benötigte Felder '. 
                     '(mit einem <span class="form-required" title="'.__('This field is mandatory', 'cvtx').'">*<'.
...
function cvtx_create_aeantrag_form($cvtx_aeantrag_antrag = 0, $cvtx_aeantrag_zeile  = '', $cvtx_aeantrag_text  = '', $cvtx_aeantrag_steller = '',
  ...
  <form id="create_aeantrag_form" class="cvtx_antrag_form cvtx_form" method="post" action="">
    ...
    <fieldset class="fieldset">
	    <div class="legend"><h3><?php echo __('Line', 'cvtx'); ?></h3></div>
    
	    <div class="form-item">
		    <label for="cvtx_aeantrag_zeile"><?php echo __('Line', 'cvtx'); ?>: <span class="form-required" title="<?php echo __('This field is mandatory', 'cvtx'); ?>">*</span></label><br/>
    ...
    <fieldset class="fieldset">
    	...
    	<div class="form-group">
	    	<div class="form-item">
		    	<label for="cvtx_aeantrag_steller"><?php echo __('Author(s)', 'cvtx'); ?>: <span class="form-required" title="<?php echo __('This field is mandatory', 'cvtx'); ?>">*</span></label><br/>
	    	...
	    	<div class="form-item">
			    <label for="cvtx_aeantrag_email"><?php echo __('e-mail address', 'cvtx'); ?>: <span class="form-required" title="<?php echo __('This field is mandatory', 'cvtx'); ?>">*</span></label> (<?php echo __('will not be published', 'cvtx'); ?>)<br/>
	  	  ...
	  	  <div class="form-item">
  			  <label for="cvtx_aeantrag_phone"><?php echo __('mobile number', 'cvtx'); ?>: <span class="form-required" title="<?php echo __('This field is mandatory', 'cvtx'); ?>">*</span></label> (<?php echo __('will not be published', 'cvtx'); ?>)<br/>
    ...
    <fieldset class="fieldset">
	    ...
	    <div class="form-item">
    		<label for="cvtx_aeantrag_text"><?php echo __('Text', 'cvtx'); ?>: <span class="form-required" title="<?php echo __('This field is mandatory', 'cvtx'); ?>">*</span></label><br/>
    		<?php include_once( ABSPATH . 'wp-admin/includes/plugin.php' );
  	  	if(is_plugin_active('html-purified/html-purified.php')) {    
	    ...
	    <div class="form-item">
	  	  <label for="cvtx_aeantrag_grund"><?php echo __('Explanation', 'cvtx'); ?>:</label><br/>
	  	  <?php if(is_plugin_active('html-purified/html-purified.php')) {    
    ...
    <fieldset class="fieldset">
      ...
      <div class="form-item">
	      <input type="submit" id="cvtx_aeantrag_submit" class="submit" value="<?php echo __('Submit amendment', 'cvtx'); ?>">
     	</div>
            ...
            if (!empty($cvtx_aeantrag_zeile) && !empty($cvtx_aeantrag_text) && !empty($cvtx_aeantrag_steller)
             && !empty($cvtx_aeantrag_antrag) && !empty($cvtx_aeantrag_email) && !empty($cvtx_aeantrag_phone)) {
                ...
                if($antrag_id = wp_insert_post($aeantrag_data)) {
                    echo '<p id="message" class="success">'.__('The amendment has been created but it is not plublished yet', 'cvtx').'</p>';
                    $erstellt = true;
                }
                else {
