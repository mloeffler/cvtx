...
\ohead{<?php cvtx_print_latex(__('Amendment', 'cvtx')); ?> <?php cvtx_kuerzel($post); ?>}
...
\begin{tabularx}{\textwidth}{|lX|}
    ...
    <?php cvtx_print_latex(__('Author(s)', 'cvtx')); ?>:    &   <?php cvtx_antragsteller_kurz($post); ?>                          \\
                                                            &                                                                     \\
    <?php cvtx_print_latex(__('Concerning', 'cvtx')); ?>:   &   <?php cvtx_antrag($post); ?> (<?php cvtx_top_titel($post); ?>)    \\
                                                            &                                                                     \\
...
\section*{<?php cvtx_print_latex(__('Amendment', 'cvtx')); ?> <?php cvtx_kuerzel($post); ?>}
