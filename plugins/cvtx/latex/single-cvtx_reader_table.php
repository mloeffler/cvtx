...
\begin{tabularx}{\textwidth}{p{1.5cm}p{3cm}>{\hsize=1.2\hsize}X>{\hsize=.8\hsize}X}
    ...
    \multicolumn{4}{|l|}{<?php cvtx_print_latex(__('Author(s)', 'cvtx')); echo(': '); cvtx_antragsteller_kurz($reso); ?>}   \\
    \multicolumn{4}{|l|}{}   \\
    \multicolumn{1}{|c}{\textbf{<?php cvtx_print_latex(__('Line', 'cvtx')); ?>}}        &
    \multicolumn{1}{c} {\textbf{<?php cvtx_print_latex(__('Author(s)', 'cvtx')); ?>}}   &
    \multicolumn{1}{c} {\textbf{<?php cvtx_print_latex(__('Amendment', 'cvtx')); ?>}}   &
    \multicolumn{1}{c|}{\textbf{<?php cvtx_print_latex(__('Procedure', 'cvtx')); ?>}}   \\
    \hline
    \hline
<?php
