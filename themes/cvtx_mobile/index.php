		...
		<?php if (have_posts()) : ?>
			...
			<?php while (have_posts()) : the_post(); ?>
				...
				<div <?php post_class(); ?> id="post-<?php the_ID(); ?>">
					...
					<p class="postmetadata"><small><?php the_tags(__('Tags:', 'cvtx_theme') . ' ', ', ', '<br />'); ?> <?php printf(__('Published in %s', 'cvtx_theme'), get_the_category_list(', ')); ?> | <?php edit_post_link(__('Edit', 'cvtx_theme'), '', ' | '); ?>  <?php comments_popup_link(__('No comments &#187;', 'cvtx_theme'), __('1 comment &#187;', 'cvtx_theme'), __('% comments &#187;', 'cvtx_theme'), '', __('Comments closed', 'cvtx_theme') ); ?></small></p>
				</div>
