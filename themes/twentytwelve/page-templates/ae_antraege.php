...
<html lang="<?php bloginfo('language'); ?>">
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/page-templates/ae_antraege.css" type="text/css" media="screen" />
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/page-templates/ae_antraege_print.css" type="text/css" media="print" />
    <?php wp_head(); ?>
  </head>
  ...
  <body>
    ...
    <div id="header">
      <div id="verlauf">
        <p><a href="<?php bloginfo('url'); ?>"><< <?php echo __('Back to the page', 'twentytwelve'); ?></a> <span class="right"><?php bloginfo('name'); ?></span></p>
      </div>
    </div>
    ...
    if($loop->have_posts()):?>
      <div id="liste">
        <div class="toggler"><a href="#"><?php if($hide) print __('Show filters','twentytwelve'); else print __('Hide filters', 'twentytwelve'); ?></a></div>
        <form method="post" id="filter" <?php if($hide) print 'style="display:none"'; ?> >
          <label for="tops"><?php print __('Agenda points and amendments', 'twentytwelve'); ?></label>
          ...
          <p>
            ...
            <label for="show_empty"><?php print __('Show only resolutions with amendments', 'twentytwelve'); ?></label>
            <input id="show_verfahren" name="show_verfahren" type="checkbox" <?php if($show_verfahren) print 'checked="true"'; ?> />
            <label for="show_verfahren"><?php print __('Show procedure', 'twentytwelve'); ?></label>
            <input id="show_steller" name="show_steller" type="checkbox" <?php if($show_steller) print 'checked="true"'; ?> />
            <label for="show_steller"><?php print __('Show full authors field','twentytwelve'); ?></label>
          </p>
          ...
          <?php if ($loop3->have_posts()): ?>
            <table>
              <tr>
                ...
                <th><?php print __('Author(s)', 'twentytwelve'); ?></th>
                <th><?php print __('Resolution', 'twentytwelve'); ?></th>
                <?php if ($show_verfahren): ?><th><?php print __('Modifications', 'twentytwelve'); ?></th><th><?php print __('Procedure', 'twentytwelve'); ?></th><?php endif; ?>
              </tr>
              <tbody>
    ...
    <script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/page-templates/ae_antraege.js"></script>
    <?php wp_footer(); ?>
